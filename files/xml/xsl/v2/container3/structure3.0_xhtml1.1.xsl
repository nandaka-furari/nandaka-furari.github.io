...
<xsl:stylesheet
        ...
        <div id="c0" class="article">
            ...
            <div class="foot">
                <div>
                    ...
                    <script type="text/javascript" src="http://s7.addthis.com/js/250/addthis_widget.js#pubid=ra-4d9330cf1edc6043"></script>
                     AddThis Button END -->
                </div>
    ...
    <xsl:template match="c:comment">
        ...
        <li class="comment" id="c{$com}">
            ...
            <ul class="foot">
                ...
                <li>
                    <a href="as{@number}.html.html">AS</a>
                </li>
                <li>
    ...
    <xsl:template name="common.attr">
        ...
        <dt>名前</dt>
        <dd class="authorName">
            <a href="/service/blog/{c:author/@type}_{c:author/@name}/">
                <xsl:text>[</xsl:text>
