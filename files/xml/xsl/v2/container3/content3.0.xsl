...
<xsl:stylesheet
    ...
    <xsl:include href="../common-xhtml2-to-xhtml1.xsl"/>
    ...
    <xsl:template match="c:h|c:td|c:th|c:label|c:li|c:dt|c:dd">
        <xsl:element name="{name()}">
            <xsl:call-template name="line.type.temp"/>
        </xsl:element>
    </xsl:template>
    ...
    <xsl:template match="c:dfn|c:span|c:abbr|c:strong|c:em|c:q|c:cite|c:code|c:var|c:samp|c:kbd|c:dt|c:caption|c:th">
        <xsl:element name="{name()}">
            <xsl:call-template name="line.type.temp"/>
        </xsl:element>
    </xsl:template>
